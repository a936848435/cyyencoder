...
# C:/Users/93684/Desktop/后门攻击你要读读看嘛/组会5月/CorruptEncoder-main/get_downstream_dataset/gen_downstream_filelist.py

parser.add_argument('--data_root', default='E:/imagenet', help='path to ImageNet dataset')parser.add_argument('--downstream_task_name', default='imagenet100_A', type=str)
